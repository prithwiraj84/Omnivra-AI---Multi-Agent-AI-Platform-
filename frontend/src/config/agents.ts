...
const SEEDS: Seed[] = [
  ...
  { id: 'frontend-engineer', name: 'Frontend Engineer', department: 'Engineering', provider: 'openrouter', model: 'poolside/laguna-s-2.1:free', modelLabel: 'Laguna S 2.1' },
  { id: 'backend-engineer', name: 'Backend Engineer', department: 'Engineering', provider: 'openrouter', model: 'nvidia/nemotron-3-ultra-550b-a55b:free', modelLabel: 'Nemotron Ultra 550B' },
  { id: 'api-engineer', name: 'API Engineer', department: 'Engineering', provider: 'openrouter', model: 'nvidia/nemotron-3-ultra-550b-a55b:free', modelLabel: 'Nemotron Ultra 550B' },
  { id: 'qa-engineer', name: 'QA Engineer', department: 'Quality & Security', provider: 'google_ai', model: 'gemini-3.1-flash-lite', modelLabel: 'Gemini 3.1 Flash Lite' },
  ...
  { id: 'social-strategist', name: 'Social Strategist', department: 'Marketing', provider: 'openrouter', model: 'inclusionai/ling-3.0-flash:free', modelLabel: 'Ling 3.0 Flash' },
  ...
  { id: 'task-classifier', name: 'Task Classifier', department: 'System Ops', provider: 'openrouter', model: 'cohere/north-mini-code:free', modelLabel: 'North Mini Code', kind: 'system' },
  { id: 'workflow-router', name: 'Workflow Router', department: 'System Ops', provider: 'openrouter', model: 'cohere/north-mini-code:free', modelLabel: 'North Mini Code', kind: 'system' },
  { id: 'memory-retrieval', name: 'Memory Retrieval', department: 'System Ops', provider: 'openrouter', model: 'cohere/north-mini-code:free', modelLabel: 'North Mini Code', kind: 'system' },
  { id: 'notification-agent', name: 'Notification Agent', department: 'System Ops', provider: 'openrouter', model: 'cohere/north-mini-code:free', modelLabel: 'North Mini Code', kind: 'system' },
  { id: 'log-analyzer', name: 'Log Analyzer', department: 'System Ops', provider: 'openrouter', model: 'cohere/north-mini-code:free', modelLabel: 'North Mini Code', kind: 'system' },
