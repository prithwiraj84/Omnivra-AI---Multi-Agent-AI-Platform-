...
const SEEDS: Seed[] = [
  { id: 'ceo-manager', name: 'CEO / Manager', department: 'Executive', provider: 'google_ai', model: 'gemini-2.5-flash', modelLabel: 'Gemini 2.5 Flash' },
  ...
  { id: 'uiux-designer', name: 'UI/UX Designer', department: 'Design', provider: 'google_ai', model: 'gemini-2.5-flash', modelLabel: 'Gemini 2.5 Flash' },
  ...
  { id: 'social-strategist', name: 'Social Strategist', department: 'Marketing', provider: 'openrouter', model: 'deepseek/deepseek-v4-flash:free', modelLabel: 'DeepSeek V4 Flash' },
  ...
  { id: 'image-generation', name: 'Image Generation', department: 'Media', provider: 'huggingface', model: 'black-forest-labs/FLUX.1-dev', modelLabel: 'FLUX.1-dev', kind: 'media' },
]
