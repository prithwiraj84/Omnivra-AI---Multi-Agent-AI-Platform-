...
const SEEDS: Seed[] = [
  ...
  { id: 'documentation-agent', name: 'Documentation Agent', department: 'Documentation', provider: 'groq', model: 'llama-3.3-70b-versatile', modelLabel: 'Llama 3.3 70B' },
  { id: 'presentation-designer', name: 'Presentation Designer', department: 'Documentation', provider: 'groq', model: 'llama-3.3-70b-versatile', modelLabel: 'Llama 3.3 70B' },
