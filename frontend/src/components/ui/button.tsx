...
/**
 * Button — Omnivra primary action primitive.
 * Variants restyled to the design tokens: `default` is the cyber-cyan primary,
 * plus secondary / ghost / outline / destructive. Relies on the CSS variables
 * declared in `src/index.css` (no hardcoded colors).
 */
const buttonVariants = cva(
    ...
    '[&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow-neon-cyan hover:brightness-110 hover:shadow-glow-cyan active:brightness-95',
