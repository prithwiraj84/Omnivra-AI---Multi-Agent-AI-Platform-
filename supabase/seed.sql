...
from (values
  ...
  ('documentation_agent','Documentation Agent',  'Docs',                'documentation',  'groq',            'llama-3.3-70b-versatile',                'file-text',    false, 13),
  ('presentation_designer','Presentation Designer','Decks',             'documentation',  'groq',            'llama-3.3-70b-versatile',                'presentation', false, 14),
