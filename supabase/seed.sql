...
insert into public.providers (key, name, base_url, docs_url) values
  ...
  ('huggingface',     'Hugging Face',    'https://api-inference.huggingface.co',    'https://huggingface.co/docs')
...
from (values
  ('google_ai_studio','gemini-2.5-flash',                         'Gemini 2.5 Flash',          'multimodal', false),
  ...
  ('openrouter',      'deepseek/deepseek-v4-flash:free',          'DeepSeek V4 Flash (free)',  'text',       true),
  ...
  ('huggingface',     'black-forest-labs/FLUX.1-dev',             'FLUX.1-dev',                'image',      false),
...
from (values
  ...
  ('ceo_manager',        'CEO / Manager',        'Chief Executive',     'executive',      'google_ai_studio','gemini-2.5-flash',                       'crown',        false, 1),
  ('solution_architect', 'Solution Architect',   'System Design',       'architecture',   'openrouter',      'openai/gpt-oss-120b:free',               'layout-grid',  false, 2),
  ('uiux_designer',      'UI/UX Designer',       'Product Design',      'design',         'google_ai_studio','gemini-2.5-flash',                       'palette',      false, 3),
  ...
  ('social_strategist',  'Social Strategist',    'Social',              'marketing',      'openrouter',      'deepseek/deepseek-v4-flash:free',        'share-2',      false, 11),
  ...
  ('image_generation',   'Image Generation',     'Media',               'media',          'huggingface',     'black-forest-labs/FLUX.1-dev',           'image',        true,  23)
