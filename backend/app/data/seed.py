...
def build_dashboard() -> DashboardPayload:
    ...
    return DashboardPayload(
        ...
        model_usage=[
            ...
            ModelUsage(id="nvidia/nemotron-3-ultra-550b-a55b:free", pct=24, calls=1384, color=CATEGORICAL[1]),
            ModelUsage(id="nvidia/nemotron-3-super-120b", pct=18, calls=288, color=CATEGORICAL[2]),
            ModelUsage(id="poolside/laguna-s-2.1:free", pct=12, calls=192, color=CATEGORICAL[3]),
            ModelUsage(id="google/gemma-4-31b-it:free", pct=8, calls=128, color=CATEGORICAL[4]),
            ModelUsage(id="cohere/north-mini-code:free", pct=6, calls=96, color=CATEGORICAL[5]),
        ],
        media_services=[
